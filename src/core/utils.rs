...
use windows::Win32::{
    Foundation::{CloseHandle, VARIANT_FALSE, VARIANT_TRUE},
    System::{
        Com::{CLSCTX_ALL, COINIT_APARTMENTTHREADED, CoCreateInstance}, ProcessStatus::{EnumProcesses, GetModuleBaseNameW}, TaskScheduler::{
        ...
        }, Threading::{OpenProcess, PROCESS_QUERY_INFORMATION, PROCESS_VM_READ}, Variant::VARIANT
    },
...
pub fn get_running_process_names() -> Vec<String> {
    ...
    unsafe {
        ...
        for &pid in &process_ids[0..count] {
            if pid == 0 { continue; } // System Idle Process はスキップ
